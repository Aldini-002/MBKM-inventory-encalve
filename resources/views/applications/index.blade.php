    ...
    <div id="kt_app_toolbar" class="app-toolbar pb-3 pb-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/applications/create" class="btn btn-sm fw-bold btn-primary">Add application</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <table class="table table-row-bordered table-row-gray-700 align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bold text-muted bg-light">
                            ...
                            <th class="min-w-125px text-end">Application</th>
                    ...
                    <!--begin::Table body-->
                    <tbody>
                        @foreach ($applications as $i => $data)
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-gray-700 fw-bold d-block fs-6 text-end"><span
                                            class="btn btn-sm btn-primary">{{ count($furniture_applications->where('application_id', $data->id)) }}
                                        </span>
                                    </span>
                                </td>
                                <td class="text-end">
                                    <div class="d-flex align-items-center justify-content-end gap-1">
                                        <a href="/furnitures?application={{ strtolower($data->name) }}"
                                            class="btn btn-light-primary fw-bold btn-sm">View
                                            {{ count($furniture_applications->where('application_id', $data->id)) }}
                                            furnitures</a>
                                        <a href="/applications/edit/{{ $data->id }}?index=1"
