                ...
                <div class="col-12">
                    <div class="card card-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Daftar Finishing</h3>
                            ...
                            <table class="table table-hover text-nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-right"><a href="/finishings/create"
                                ...
                                <tbody>
                                    @foreach ($finishings as $data)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                {{ count($furniture_finishings->where('finishing_id', $data->id)) }}</td>
                                            <td class="text-right">{{ $data->created_at->format('d/m/Y') }}</td>
                                            <td class="project-actions text-right">
                                                <div class="d-flex justify-content-end">
                                                    <a class="btn btn-info btn-sm mr-1"
                                                        href="/finishings/{{ $data->id }}/edit">
