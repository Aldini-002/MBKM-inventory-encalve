            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                {{-- <div class="m-0">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown w-100 w-md-500px" data-kt-menu="true"
                        ...
                        <!--end::Menu separator-->
                        <!--begin::Form-->
                        <form action="/finishings" method="get">
                            <div class="px-7 py-5">
                                <!--begin::Input group-->
                                <div class="mb-10">
                                    <!--begin::Label-->
                ...
                <a href="/finishings/create" class="btn btn-sm fw-bold btn-primary">Add finishing</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <table class="table table-row-bordered table-row-gray-700 align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bold text-muted bg-light">
                            ...
                            <th class="min-w-125px text-end">Finishing</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-gray-700 fw-bold d-block fs-6 text-end"><span
                                            class="btn btn-sm btn-primary">{{ count($furniture_finishings->where('finishing_id', $data->id)) }}
                                        </span>
                                    </span>
                                </td>
                                <td class="text-end">
                                    <div class="d-flex align-items-center justify-content-end gap-1">
                                        <a href="/furnitures?finishing={{ strtolower($data->name) }}"
                                            class="btn btn-light-primary fw-bold btn-sm">View
                                            {{ count($furniture_finishings->where('finishing_id', $data->id)) }}
                                            furnitures</a>
                                        <a href="/finishings/edit/{{ $data->id }}?index=1"
                                            class="btn btn-light-warning fw-bold btn-sm">Edit</a>
                                        <form action="/finishings/{{ $data->id }}" method="POST">
                                            @csrf
                                            @method('delete')
