            ...
            <form action="/furnitures" method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="material_id" class="col-sm-2 col-form-label">Material<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-10">
                                <select class="select2" name="material_id[]" id="material_id" multiple="multiple"
                                    data-placeholder="Pilih material" style="width: 100%;" required>
                                    @foreach ($materials as $data)
                                        <option value="{{ $data->id }}"
                                            {{ old('material_id') && in_array($data->id, old('material_id')) ? 'selected' : '' }}>
                                            {{ $data->name }}</option>
                                    @endforeach
                                </select>
                                @error('material_id')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control select2" name="port" id="port" style="width: 100%;">
                                    <option value=' Tanjung Mas' {{ old('port') == 'Tanjung Mas' ? 'selected' : '' }}>
                                        Tanjung Mas</option>
                                    <option value=' Tanjung Priok' {{ old('port') == 'Tanjung Priok' ? 'selected' : '' }}>
                                        Tanjung Priok</option>
                                    <option value=' Tanjung Perak' {{ old('port') == 'Tanjung Perak' ? 'selected' : '' }}>
                                        Tanjung Perak</option>
                                    <option value=' Belawan' {{ old('port') == 'Belawan' ? 'selected' : '' }}>Belawan
                                    </option>
                                    <option value=' Merak' {{ old('port') == 'Merak' ? 'selected' : '' }}>Merak</option>
                                    <option value=' Benoa' {{ old('port') == 'Benoa' ? 'selected' : '' }}>Benoa</option>
                                    <option value=' Makassar' {{ old('port') == 'Makassar' ? 'selected' : '' }}>Makassar
                                    </option>
                                    <option value=' Palembang' {{ old('port') == 'Palembang' ? 'selected' : '' }}>
                                        Palembang
                                    </option>
                                    <option value=' Sorong' {{ old('port') == 'Sorong' ? 'selected' : '' }}>Sorong
                                    </option>
                                    <option value=' Manado' {{ old('port') == 'Manado' ? 'selected' : '' }}>Manado
                                    </option>
                                    <option value=' Banjarmasin' {{ old('port') == 'Banjarmasin' ? 'selected' : '' }}>
                                        Banjarmasin</option>
                                    <option value=' Balikpapan' {{ old('port') == 'Balikpapan' ? 'selected' : '' }}>
                                        Balikpapan</option>
                                    <option value=' Jayapura' {{ old('port') == 'Jayapura' ? 'selected' : '' }}>Jayapura
                                    </option>
                                    <option value=' Ambon' {{ old('port') == 'Ambon' ? 'selected' : '' }}>Ambon</option>
                                    <option value=' Lampung' {{ old('port') == 'Lampung' ? 'selected' : '' }}>Lampung
                                    </option>
                                    <option value=' Semarang' {{ old('port') == 'Semarang' ? 'selected' : '' }}>Semarang
                                    </option>
                                    <option value=' Padang' {{ old('port') == 'Padang' ? 'selected' : '' }}>Padang
                                    </option>
                                    <option value=' Lombok' {{ old('port') == 'Lombok' ? 'selected' : '' }}>Lombok
                                    </option>
                                    <option value=' Surabaya' {{ old('port') == 'Surabaya' ? 'selected' : '' }}>Surabaya
                                    </option>
                                    <option value=' Bitung' {{ old('port') == 'Bitung' ? 'selected' : '' }}>Bitung
                                    </option>
                                    <option value=' Ternate' {{ old('port') == 'Ternate' ? 'selected' : '' }}>Ternate
                                    </option>
                                </select>
                                @error('port')
                                    <small class="text-danger font-italic">{{ $message }}</small>
