    ...
    <div id="kt_app_toolbar" class="app-toolbar pb-3 pb-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="/materials/create" class="btn btn-sm fw-bold btn-primary">Add material</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <table class="table table-row-bordered table-row-gray-700 align-middle gs-0 gy-4">
                    ...
                    <thead>
                        <tr class="fw-bold text-muted bg-light">
                            ...
                            <th class="min-w-125px text-end">Material</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-gray-700 fw-bold d-block fs-6 text-end"><span
                                            class="btn btn-sm btn-primary">{{ count($furniture_materials->where('material_id', $data->id)) }}
                                        </span>
                                    </span>
                                </td>
                                <td class="text-end">
                                    <div class="d-flex align-items-center justify-content-end gap-1">
                                        <a href="/furnitures?material={{ strtolower($data->name) }}"
                                            class="btn btn-light-primary fw-bold btn-sm">View
                                            {{ count($furniture_materials->where('material_id', $data->id)) }}
                                            furnitures</a>
                                        <a href="/materials/edit/{{ $data->id }}?index=1"
                                            class="btn btn-light-warning fw-bold btn-sm">Edit</a>
                                        <form action="/materials/{{ $data->id }}" method="POST">
                                            @csrf
                                            @method('delete')
