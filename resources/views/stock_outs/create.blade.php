                                ...
                                <table class="table table-hover text-nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="" style="width: 300px">Pemasok</th>
                                    ...
                                    <tbody>
                                        @foreach ($stockoutselects as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    <select class="form-control form-control-sm" name="buyer_id[]"
                                                        id="buyer_id" style="width: 100%;" required>
                                                        @foreach ($buyers as $item)
                                                            <option value="{{ $item->id }}"
                                                                {{ old('buyer_id') == $item->id ? 'selected' : '' }}>
                                                                {{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
